    ...
    <body>
        <div class="container">
            ...
            <form action="Cadastro-fornecedor.php" method="POST" class="form-group">
                <label for="razao">Razão Social</label><input type="text" name="razaoS" id="razao" placeholder="Ex:Rações S.A" required>
                <label for="cnpj1">CNPJ</label><input type="text" name="cnpj" id="cnpj1" placeholder="00.000.000/0001-00" required>
                <label for="categoria1">Categoria</label><input type="text" name="categoria" id="categoria1" placeholder="Ex:Higiene, Alimentos..." required>
